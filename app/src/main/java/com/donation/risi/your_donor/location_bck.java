 ...
 */
@SuppressLint("NewApi")
public class location_bck extends JobService implements
    ...
    private void getLastKnownLocation() {
        ...
        if (lastLocation != null) {
            ...
            Toast.makeText(this,lastLocation.getLongitude()+" "+lastLocation.getLatitude(),Toast.LENGTH_SHORT).show();
            writeLastLocation();
